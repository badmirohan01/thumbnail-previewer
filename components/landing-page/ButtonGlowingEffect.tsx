...
export default function ButtonGlowing({ text, href = '#' }: ButtonGlowingProps) {
    return (
        <div className="p-8 flex items-center justify-center">
            <Link href={href} className="group relative inline-flex items-center gap-2 rounded-full bg-black px-4 py-2 text-sm text-white transition-all hover:bg-white/5"
            >
